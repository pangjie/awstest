...
import type { DashboardFilters, DashboardSortState, EmployeeSortState } from "./types";

export default function TimekeepingModule({page,titleTarget,isAdmin,initialScanBadge,initialRecordBadge,openScan,openRecords,dashboardDate,dashboardExportStartDate,dashboardExportEndDate,dashboardFilters,setDashboardFilters,dashboardSort,setDashboardSort,dashboardExportKey,dashboardImportOpen,closeDashboardImport,employeeSort,setEmployeeSort,portableDevice}:{page:TimekeepingPageKey;titleTarget:HTMLDivElement|null;isAdmin:boolean;initialScanBadge:string;initialRecordBadge:string;openScan?:((badge:string)=>void);openRecords?:((badge:string)=>void);dashboardDate:string;dashboardExportStartDate:string;dashboardExportEndDate:string;dashboardFilters:DashboardFilters;setDashboardFilters:Dispatch<SetStateAction<DashboardFilters>>;dashboardSort:DashboardSortState;setDashboardSort:Dispatch<SetStateAction<DashboardSortState>>;dashboardExportKey:number;dashboardImportOpen:boolean;closeDashboardImport:()=>void;employeeSort:EmployeeSortState;setEmployeeSort:Dispatch<SetStateAction<EmployeeSortState>>;portableDevice:boolean}){
  switch(page){
