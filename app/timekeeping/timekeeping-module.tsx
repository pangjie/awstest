...
export default function TimekeepingModule({page,titleTarget,isAdmin,initialRecordBadge,openRecords,dashboardDate,dashboardRange,dashboardExportKey,dashboardImportOpen,closeDashboardImport}:{page:TimekeepingPageKey;titleTarget:HTMLDivElement|null;isAdmin:boolean;initialRecordBadge:string;openRecords?:((badge:string)=>void);dashboardDate:string;dashboardRange:DashboardRangeId;dashboardExportKey:number;dashboardImportOpen:boolean;closeDashboardImport:()=>void}){
  switch(page){
    case "time-scan":return <ScanPage titleTarget={titleTarget}/>;
    ...
    case "time-employees":return <EmployeesPage titleTarget={titleTarget} openRecords={openRecords}/>;
  }
}
