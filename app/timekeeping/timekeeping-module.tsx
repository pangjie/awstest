...
export default function TimekeepingModule({page,titleTarget,isAdmin,initialScanBadge,initialRecordBadge,openScan,openRecords,dashboardDate,dashboardExportStartDate,dashboardExportEndDate,dashboardFilters,setDashboardFilters,dashboardExportKey,dashboardImportOpen,closeDashboardImport,employeeSort,setEmployeeSort}:{page:TimekeepingPageKey;titleTarget:HTMLDivElement|null;isAdmin:boolean;initialScanBadge:string;initialRecordBadge:string;openScan?:((badge:string)=>void);openRecords?:((badge:string)=>void);dashboardDate:string;dashboardExportStartDate:string;dashboardExportEndDate:string;dashboardFilters:DashboardFilters;setDashboardFilters:Dispatch<SetStateAction<DashboardFilters>>;dashboardExportKey:number;dashboardImportOpen:boolean;closeDashboardImport:()=>void;employeeSort:EmployeeSortState;setEmployeeSort:Dispatch<SetStateAction<EmployeeSortState>>}){
  switch(page){
